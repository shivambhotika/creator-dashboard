...
export const KNOWN_ISSUES: DataIssue[] = [
  ...
  { id: "dq-v63-slug", entityType: "video", entityId: "v63", severity: "resolved", issueType: "dub_failed", title: "Full Disclosure: unique Dub slug configured", description: "Full Disclosure (v63) now uses the unique slug 'fulldisclosureyt' and is mapped separately from v53 financewithjobi.", suggestedFix: "None — resolved", owner: "WLDD", status: "resolved" },
